...
export default (req: NextApiRequest, res: NextApiResponse) => {
  ...
  res.status(200).send(apiPageContent);
}
  ...
  <main class="content">
    <section class="section" id="usage">
      <div class="inner">
        ...
        <ul>
          <li>
            <code class="marker">/api/competitions</code>
            Array&lt;Competition&gt;,
            eg. <a href="https://golazon.com/api/competitions" target="_blank">golazon.com/api/competitions</a>
          </li>
          <li>
            <code class="marker">/api/competitions?q=text</code>
            Array&lt;Competition&gt;,
            eg. <a href="https://golazon.com/api/competitions?q=argentina" target="_blank">golazon.com/api/competitions?q=argentina</a>
          </li>
        </ul>
      </div>
    </section>
